...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    people: dict of people and their parents
    one_gene: set of people with 1 copy of the gene
    two_genes: set of people with 2 copies of the gene
    have_trait: set of people who have the trait
    """
    probability = 1
    ...
    for person in people:
        ...
        # Has parents: compute from parents' genes and mutation
        else:
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    Each person gets p added to their gene and trait distributions.
    """
