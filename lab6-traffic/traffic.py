...
def load_data(data_dir):
    """
    Load all images from `data_dir`, resize them to (IMG_WIDTH, IMG_HEIGHT),
    normalize pixel values, and return (images, labels) as NumPy arrays.
    """
    images = []
    labels = []
